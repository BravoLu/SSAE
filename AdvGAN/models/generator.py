...
# @Last Modified time: 2020-06-15 19:50:57
import torch
...
class MASKGenerator(nn.Module):
    def __init__(self, input_nc=3, output_nc=3, ngf=32, norm='bn', n_blocks=6):
        ...
        self.l5_1 = nn.Sequential(*end_layers)
        self.l5_2 = nn.Sequential(*end_layers2)
        # self.set_requires_grad(self)  # this line cause bug
...
if __name__ == '__main__':
    input = torch.rand(32, 3, 384, 128).cuda()
    generator = Generator().cuda()
    print(generator)
    #print(generator)
    #generator.load_state_dict(torch.load('/home/shaohao/Adversarial-attack-on-Person-ReID-With-Deep-Mis-Ranking/logs/baseline/market1501/best_G.pth.tar'))

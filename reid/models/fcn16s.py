...
class FCN16s(nn.Module):
    ...
    def __init__(self, n_class=3):
        ...
        self.score_fr_2 = nn.Conv2d(4096, 1, 1)
        self.score_pool4_2 = nn.Conv2d(512, 1, 1)
        ...
        self.upscore16_2 = nn.ConvTranspose2d(
    ...
    def forward(self, x):
        ...
        feats = self.score_fr(h)
        feats_mask = self.score_fr_2(h)

        # import pdb
        # pdb.set_trace()
        h = self.upscore2(feats)
        upscore2 = h  # 1/16
...
if __name__ == "__main__":
    a = torch.rand((16, 3, 384, 128)).cuda()
    model = FCN16s(n_class=3).cuda()
    output, mask = model(a)
